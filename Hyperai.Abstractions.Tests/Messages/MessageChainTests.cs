...
namespace Hyperai.Abstractions.Tests.Messages
{
    ...
    public class MessageChainTests
    {
        ...
        {
            // Arrange
            var c1 = new MessageChain(new List<MessageComponent> {new Plain("While I am a cat.")});
            var c2 = new MessageChain(new List<MessageComponent> {new Plain("While I am a cat.")});
            // Act
        ...
        public void ChainEquals_WithOther_ReturnsFalse()
        {
            // Arrange
            var c1 = new MessageChain(new List<MessageComponent> {new Plain("While I am a cat.")});
            var c2 = new MessageChain(new List<MessageComponent> {new Plain("While I am a dog.")});
            // Act
            var assert = c1.ChainEquals(c2);
            // Assert
